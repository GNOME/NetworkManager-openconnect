...
Build-Depends: debhelper-compat (= 12), intltool, libgcr-3-dev, libglib2.0-dev, libgtk-3-dev, libnm-dev, libnma-dev, libwebkit2gtk-4.1-dev | libwebkit2gtk-4.0-dev, libopenconnect-dev (>= 8.20~), libsecret-1-dev, libxml2-dev, systemd-dev | systemd (<< 255~)
Package-List:
